...
<div class="row-fluid">
	...
	<br />
	<form id="reportForm" role="form" action="generateSumReport.do"
		method="post">
		<input type="hidden" class="form-control" id="txnType" name="txnType"
			value="${txnType}">
		<h4>请输入报表的时间范围，点击产生报表后请保存文件至本机。本报表会输出所有分销商的数据。</h4>
		...
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default primary">产生报表</button>
		</div>
	</form>
