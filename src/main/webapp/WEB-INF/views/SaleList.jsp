...
<div class="row-fluid">
	...
	<button type="button" class="btn btn-primary btn-sm"
		onclick="javascript:window.location.href='editSale.do?mode=new'">新建销售单</button>
	<br /> <br />

	<c:choose>
		<c:when test="${isAdmin}">
			<form id="saleForm" class="form-inline" role="form"
				action="listSale.do" method="post">
				...
				<tr>
					...
					<td>
						<button class="btn btn-primary btn-xs"
							onclick="javascript:window.location.href='editSale.do?mode=edit&id=${item.id}'">明细</button>
	...
	function confirmDelete(oid){
  		...
  		if(confirmed){
  			window.location="deleteSale.do?id="+oid;
  		}
  	}
