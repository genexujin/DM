...
<div class="row-fluid">
	...
	<div class="btn-group">
		<button type="button" class="btn btn-primary btn-sm"
			onclick="javascript:window.location.href='editReturn.do?mode=edit&id=${returnId}'">&lt;
			&lt; 返回</button>			
		<button type="button" class="btn btn-primary btn-sm"
			onclick="javascript:window.location.href='editReturnLine.do?mode=new&returnId=${returnId}'">添加下一条</button>
	</div>
	<br />
	<h3>退货项明细</h3>

	<form id="returnLineForm" role="form" action="saveReturnLine.do"
		method="post">
		<input type="hidden" class="form-control" id="returnId"
			name="returnId" value="${returnId}"> <input type="hidden"
